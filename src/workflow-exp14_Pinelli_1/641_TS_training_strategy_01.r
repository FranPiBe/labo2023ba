...
PARAM <- list()
PARAM$experimento <- "TS6410_0924"

PARAM$exp_input <- "FE6310_0924"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future <- c(202107,202106,202105,202104,202103,202102)
PARAM$final_train <- c(
  202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 
  201907, 201906, 201905, 201904, 201903
)

PARAM$train$training <- c(
  202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 
...
PARAM$train$semilla <- 100393 # cambiar por su propia semilla  !!!
